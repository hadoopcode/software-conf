...
##
export SPARK_HOME=/opt/module/spark                             # (required) When it is defined, load it instead of Zeppelin embedded Spark libraries
...
export PYTHONPATH=/opt/module/python3
...
export HBASE_HOME=/opt/module/hbase                    # (require) Under which HBase scripts and configuration should be
